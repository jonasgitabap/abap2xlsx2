CLASS /nag/cl_excel_autofilters DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .

  PUBLIC SECTION.
*"* public components of class /NAG/CL_EXCEL_AUTOFILTERS
*"* do not include other source files here!!!
    ...
    METHODS size
      RETURNING
        VALUE(r_size) TYPE i .
*"* protected components of class /NAG/ABAP_EXCEL_WORKSHEETS
*"* do not include other source files here!!!
*"* protected components of class /NAG/ABAP_EXCEL_WORKSHEETS
*"* do not include other source files here!!!
  PROTECTED SECTION.
  PRIVATE SECTION.
    ...
    TYPES:
      BEGIN OF ts_autofilter,
        ...
        autofilter TYPE REF TO /nag/cl_excel_autofilter,
...
CLASS /nag/cl_excel_autofilters IMPLEMENTATION.
  ...
  METHOD add.
    ...
    IF sy-subrc = 0.
      RAISE EXCEPTION TYPE /nag/cx_excel. " adding another autofilter to sheet is not allowed
    ENDIF.

CLASS /nag/cx_excel DEFINITION
  PUBLIC
  INHERITING FROM cx_static_check
  CREATE PUBLIC .

*"* public components of class /NAG/CX_EXCEL
*"* do not include other source files here!!!
*"* protected components of class /NAG/CX_EXCEL
*"* do not include other source files here!!!
*"* protected components of class /NAG/CX_EXCEL
*"* do not include other source files here!!!
  PUBLIC SECTION.

    CONSTANTS /nag/cx_excel TYPE sotr_conc VALUE '028C0ED2B5601ED78EB6F3368B1E4F9B' ##NO_TEXT.
    ...
    METHODS if_message~get_text
        REDEFINITION .
  PROTECTED SECTION.
*"* private components of class /NAG/CX_EXCEL
*"* do not include other source files here!!!
  PRIVATE SECTION.
ENDCLASS.
...
CLASS /nag/cx_excel IMPLEMENTATION.

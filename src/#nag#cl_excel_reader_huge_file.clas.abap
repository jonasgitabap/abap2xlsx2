CLASS /nag/cl_excel_reader_huge_file DEFINITION
  PUBLIC
  ...
  PRIVATE SECTION.
    ...
    TYPES:
      BEGIN OF t_cell_content,
        datatype TYPE /nag/excel_cell_data_type,
        value    TYPE /nag/excel_cell_value,
        formula  TYPE /nag/excel_cell_formula,
        style    TYPE /nag/excel_cell_style,
      END OF t_cell_content .
    TYPES:
      BEGIN OF t_cell_coord,
        row    TYPE /nag/excel_cell_row,
        column TYPE /nag/excel_cell_column_alpha,
      END OF t_cell_coord .
    TYPES:
      BEGIN OF t_cell.
    ...
    METHODS get_style
      IMPORTING
        !iv_index            TYPE any
      RETURNING
        VALUE(ev_style_guid) TYPE /nag/excel_cell_style
      RAISING
        lcx_not_found .
...
CLASS /nag/cl_excel_reader_huge_file IMPLEMENTATION.
  ...
  METHOD load_worksheet.
    ...
    TRY.
      ...
      CATCH lcx_not_found INTO lx_not_found.
        /nag/cx_excel=>raise_text( lx_not_found->error ).
    ENDTRY.
  ENDMETHOD.

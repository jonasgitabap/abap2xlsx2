CLASS /nag/cl_excel_graph_pie DEFINITION
  PUBLIC
...
*"* public components of class /NAG/CL_EXCEL_GRAPH_PIE
*"* do not include other source files here!!!
    ...
    METHODS set_varycolor
      IMPORTING
        !ip_value TYPE c .
  PROTECTED SECTION.
*"* protected components of class /NAG/CL_EXCEL_GRAPH_PIE
*"* do not include other source files here!!!
  PRIVATE SECTION.
*"* private components of class /NAG/CL_EXCEL_GRAPH_PIE
*"* do not include other source files here!!!
ENDCLASS.



CLASS /nag/cl_excel_graph_pie IMPLEMENTATION.

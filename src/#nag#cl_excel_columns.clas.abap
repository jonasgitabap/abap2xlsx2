CLASS /nag/cl_excel_columns DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .

*"* public components of class /NAG/CL_EXCEL_COLUMNS
*"* do not include other source files here!!!
  PUBLIC SECTION.
    METHODS add
      IMPORTING
        !io_column TYPE REF TO /nag/cl_excel_column .
    METHODS clear .
    METHODS constructor .
    METHODS get
      IMPORTING

CLASS /nag/cl_excel_font DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF mty_s_font_cache,
        font_name       TYPE /nag/excel_style_font_name,
...
CLASS /nag/cl_excel_font IMPLEMENTATION.

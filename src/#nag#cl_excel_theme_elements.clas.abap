CLASS /nag/cl_excel_theme_elements DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC
  ...
  PROTECTED SECTION.
    ...
    DATA color_scheme TYPE REF TO /nag/cl_excel_theme_color_scheme .
    DATA font_scheme TYPE REF TO /nag/cl_excel_theme_font_scheme .
    DATA fmt_scheme TYPE REF TO /nag/cl_excel_theme_fmt_scheme .
  PRIVATE SECTION.
ENDCLASS.



CLASS /nag/cl_excel_theme_elements IMPLEMENTATION.
  ...
  METHOD build_xml.
    ...
    IF lo_theme IS BOUND.
      lo_theme_element ?= io_document->create_simple_element_ns( prefix = /nag/cl_excel_theme=>c_theme_prefix

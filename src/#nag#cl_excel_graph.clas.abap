CLASS /nag/cl_excel_graph DEFINITION
  PUBLIC
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES:
*"* public components of class /NAG/CL_EXCEL_GRAPH
*"* do not include other source files here!!!
    ...
    METHODS create_serie
      IMPORTING
        ...
        !ip_lbl_from_col     TYPE /nag/excel_cell_column_alpha OPTIONAL
        !ip_lbl_from_row     TYPE /nag/excel_cell_row OPTIONAL
        !ip_lbl_to_col       TYPE /nag/excel_cell_column_alpha OPTIONAL
        !ip_lbl_to_row       TYPE /nag/excel_cell_row OPTIONAL
        !ip_lbl              TYPE string OPTIONAL
        !ip_ref_from_col     TYPE /nag/excel_cell_column_alpha OPTIONAL
        !ip_ref_from_row     TYPE /nag/excel_cell_row OPTIONAL
        !ip_ref_to_col       TYPE /nag/excel_cell_column_alpha OPTIONAL
        !ip_ref_to_row       TYPE /nag/excel_cell_row OPTIONAL
        !ip_ref              TYPE string OPTIONAL
        !ip_sername          TYPE string
        !ip_sheet            TYPE /nag/excel_sheet_title OPTIONAL .
    METHODS set_style
      IMPORTING
  ...
  PROTECTED SECTION.
*"* protected components of class /NAG/CL_EXCEL_GRAPH
*"* do not include other source files here!!!
  PRIVATE SECTION.
*"* private components of class /NAG/CL_EXCEL_GRAPH
*"* do not include other source files here!!!
ENDCLASS.



CLASS /nag/cl_excel_graph IMPLEMENTATION.
  ...
  METHOD create_serie.
    ...
    IF ip_lbl IS NOT SUPPLIED.
      ...
      ls_serie-lbl = /nag/cl_excel_common=>escape_string( ip_value = ls_serie-lbl ).
    ...
    IF ip_ref IS NOT SUPPLIED.
      ...
      ls_serie-ref = /nag/cl_excel_common=>escape_string( ip_value = ls_serie-ref ).

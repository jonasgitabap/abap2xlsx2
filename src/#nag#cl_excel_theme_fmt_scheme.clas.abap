CLASS /nag/cl_excel_theme_fmt_scheme DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS /NAG/CL_EXCEL_THEME_FMT_SCHEME IMPLEMENTATION.
  ...
  METHOD load.
    fmt_scheme = /nag/cl_excel_common=>clone_ixml_with_namespaces( io_fmt_scheme ).
  ENDMETHOD.                    "load

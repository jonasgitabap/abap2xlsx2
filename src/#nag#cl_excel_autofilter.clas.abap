CLASS /nag/cl_excel_autofilter DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .

*"* public components of class /NAG/CL_EXCEL_AUTOFILTER
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF ts_filter,
        ...
        t_values         TYPE HASHED TABLE OF /nag/excel_cell_value WITH UNIQUE KEY table_line,
    ...
    DATA filter_area TYPE /nag/excel_s_autofilter_area .
    ...
    METHODS get_filter_area
      RETURNING
        VALUE(rs_area) TYPE /nag/excel_s_autofilter_area
      RAISING
        /nag/cx_excel .
    METHODS get_filter_range
      RETURNING
        VALUE(r_range) TYPE /nag/excel_cell_value
      RAISING
        /nag/cx_excel.
    METHODS get_filter_reference
      RETURNING
        VALUE(r_ref) TYPE /nag/excel_range_value
      RAISING
        /nag/cx_excel .
    METHODS get_values
      RETURNING
        VALUE(rt_filter) TYPE /nag/excel_t_autofilter_values .
    METHODS is_row_hidden
      IMPORTING
        !iv_row             TYPE /nag/excel_cell_row
      RETURNING
        VALUE(rv_is_hidden) TYPE abap_bool .
    METHODS set_filter_area
      IMPORTING
        !is_area TYPE /nag/excel_s_autofilter_area .
    METHODS set_text_filter
      IMPORTING
        !i_column            TYPE /nag/excel_cell_column
    ...
    METHODS set_value
      IMPORTING
        !i_column TYPE /nag/excel_cell_column
        !i_value  TYPE /nag/excel_cell_value .
    METHODS set_values
      IMPORTING
        !it_values TYPE /nag/excel_t_autofilter_values .
*"* protected components of class /NAG/ABAP_EXCEL_WORKSHEET
*"* do not include other source files here!!!
  PROTECTED SECTION.
    ...
    METHODS is_row_hidden_single_values
      IMPORTING
        !iv_row             TYPE /nag/excel_cell_row
        !iv_col             TYPE /nag/excel_cell_column
    ...
    METHODS is_row_hidden_text_pattern
      ...
      RETURNING
        VALUE(rv_is_hidden) TYPE abap_bool .
*"* private components of class /NAG/CL_EXCEL_AUTOFILTER
*"* do not include other source files here!!!
  PRIVATE SECTION.
...
CLASS /nag/cl_excel_autofilter IMPLEMENTATION.
  ...
  METHOD get_filter_range.
    ...
    l_col_start_c = /nag/cl_excel_common=>convert_column2alpha( ip_column = filter_area-col_start ) .
    l_col_end_c   = /nag/cl_excel_common=>convert_column2alpha( ip_column = filter_area-col_end ) .
  ...
  METHOD get_filter_reference.
    ...
    r_ref = /nag/cl_excel_common=>escape_string( ip_value = l_value ).
...
*  see method documentation how to use this
  ...
  METHOD validate_area.
    DATA: l_col                   TYPE /nag/excel_cell_column,
          ls_original_filter_area TYPE /nag/excel_s_autofilter_area,
          l_row                   TYPE /nag/excel_cell_row.

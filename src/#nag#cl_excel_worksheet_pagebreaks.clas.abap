CLASS /nag/cl_excel_worksheet_pagebreaks DEFINITION
  PUBLIC
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF ts_pagebreak_at ,
        ...
        cell_column TYPE /nag/excel_cell_column,
...
CLASS /nag/cl_excel_worksheet_pagebreaks IMPLEMENTATION.
  ...
  METHOD add_pagebreak.
    ...
    ls_pagebreak-cell_column = /nag/cl_excel_common=>convert_column2int( ip_column ).

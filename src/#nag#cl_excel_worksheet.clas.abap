CLASS /nag/cl_excel_worksheet DEFINITION
  PUBLIC
  CREATE PUBLIC .

  PUBLIC SECTION.
*"* public components of class /NAG/CL_EXCEL_WORKSHEET
*"* do not include other source files here!!!
*"* protected components of class /NAG/CL_EXCEL_WORKSHEET
*"* do not include other source files here!!!
*"* protected components of class /NAG/CL_EXCEL_WORKSHEET
*"* do not include other source files here!!!

    INTERFACES /nag/if_excel_sheet_printsettings .
    INTERFACES /nag/if_excel_sheet_properties .
    INTERFACES /nag/if_excel_sheet_protection .
    INTERFACES /nag/if_excel_sheet_vba_project .
    ...
    TYPES:
      BEGIN OF mty_s_ignored_errors,
        ...
        cell_coords           TYPE /nag/excel_cell_coords,
    ...
    TYPES:
      BEGIN OF mty_s_column_formula,
        id                     TYPE i,
        column                 TYPE /nag/excel_cell_column,
        formula                TYPE string,
        table_top_left_row     TYPE /nag/excel_cell_row,
        table_bottom_right_row TYPE /nag/excel_cell_row,
        table_left_column_int  TYPE /nag/excel_cell_column,
        table_right_column_int TYPE /nag/excel_cell_column,
    ...
    CONSTANTS c_break_column TYPE /nag/excel_break VALUE 2 ##NO_TEXT.
    CONSTANTS c_break_none TYPE /nag/excel_break VALUE 0 ##NO_TEXT.
    CONSTANTS c_break_row TYPE /nag/excel_break VALUE 1 ##NO_TEXT.
    CONSTANTS:
      BEGIN OF c_area,
        whole   TYPE ty_area VALUE 'W',                     "#EC NOTEXT
        topleft TYPE ty_area VALUE 'T',                     "#EC NOTEXT
      END OF c_area .
    DATA excel TYPE REF TO /nag/cl_excel READ-ONLY .
    DATA print_gridlines TYPE /nag/excel_print_gridlines READ-ONLY VALUE abap_false ##NO_TEXT.
    DATA sheet_content TYPE /nag/excel_t_cell_data .
    DATA sheet_setup TYPE REF TO /nag/cl_excel_sheet_setup .
    DATA show_gridlines TYPE /nag/excel_show_gridlines READ-ONLY VALUE abap_true ##NO_TEXT.
    DATA show_rowcolheaders TYPE /nag/excel_show_gridlines READ-ONLY VALUE abap_true ##NO_TEXT.
    DATA tabcolor TYPE /nag/excel_s_tabcolor READ-ONLY .
    ...
    METHODS add_comment
      IMPORTING
        !ip_comment TYPE REF TO /nag/cl_excel_comment .
    METHODS add_drawing
      IMPORTING
        !ip_drawing TYPE REF TO /nag/cl_excel_drawing .
    METHODS add_new_column
      IMPORTING
        !ip_column       TYPE simple
      RETURNING
        VALUE(eo_column) TYPE REF TO /nag/cl_excel_column
      RAISING
        /nag/cx_excel .
    METHODS add_new_style_cond
      ...
      RETURNING
        VALUE(eo_style_cond) TYPE REF TO /nag/cl_excel_style_cond .
    METHODS add_new_data_validation
      RETURNING
        VALUE(eo_data_validation) TYPE REF TO /nag/cl_excel_data_validation .
    METHODS add_new_range
      RETURNING
        VALUE(eo_range) TYPE REF TO /nag/cl_excel_range .
    METHODS add_new_row
      IMPORTING
        !ip_row       TYPE simple
      RETURNING
        VALUE(eo_row) TYPE REF TO /nag/cl_excel_row .
    METHODS bind_alv
      IMPORTING
        ...
        !table_style TYPE /nag/excel_table_style OPTIONAL
    ...
    METHODS bind_table
      IMPORTING
        ...
        !it_field_catalog       TYPE /nag/excel_t_fieldcatalog OPTIONAL
        !is_table_settings      TYPE /nag/excel_s_table_settings OPTIONAL
      ...
      EXPORTING
        !es_table_settings      TYPE /nag/excel_s_table_settings
      RAISING
        /nag/cx_excel .
    ...
    METHODS change_area_style
      IMPORTING
        ...
        !ip_row           TYPE /nag/excel_cell_row OPTIONAL
        !ip_row_to        TYPE /nag/excel_cell_row OPTIONAL
        !ip_style_changer TYPE REF TO /nag/if_excel_style_changer
      RAISING
        /nag/cx_excel .
    METHODS change_cell_style
      IMPORTING
        ...
        !ip_row                         TYPE /nag/excel_cell_row OPTIONAL
        !ip_complete                    TYPE /nag/excel_s_cstyle_complete OPTIONAL
        !ip_xcomplete                   TYPE /nag/excel_s_cstylex_complete OPTIONAL
        !ip_font                        TYPE /nag/excel_s_cstyle_font OPTIONAL
        !ip_xfont                       TYPE /nag/excel_s_cstylex_font OPTIONAL
        !ip_fill                        TYPE /nag/excel_s_cstyle_fill OPTIONAL
        !ip_xfill                       TYPE /nag/excel_s_cstylex_fill OPTIONAL
        !ip_borders                     TYPE /nag/excel_s_cstyle_borders OPTIONAL
        !ip_xborders                    TYPE /nag/excel_s_cstylex_borders OPTIONAL
        !ip_alignment                   TYPE /nag/excel_s_cstyle_alignment OPTIONAL
        !ip_xalignment                  TYPE /nag/excel_s_cstylex_alignment OPTIONAL
        !ip_number_format_format_code   TYPE /nag/excel_number_format OPTIONAL
        !ip_protection                  TYPE /nag/excel_s_cstyle_protection OPTIONAL
        !ip_xprotection                 TYPE /nag/excel_s_cstylex_protection OPTIONAL
        !ip_font_bold                   TYPE flag OPTIONAL
        !ip_font_color                  TYPE /nag/excel_s_style_color OPTIONAL
        !ip_font_color_rgb              TYPE /nag/excel_style_color_argb OPTIONAL
        !ip_font_color_indexed          TYPE /nag/excel_style_color_indexed OPTIONAL
        !ip_font_color_theme            TYPE /nag/excel_style_color_theme OPTIONAL
        !ip_font_color_tint             TYPE /nag/excel_style_color_tint OPTIONAL
        !ip_font_family                 TYPE /nag/excel_style_font_family OPTIONAL
        !ip_font_italic                 TYPE flag OPTIONAL
        !ip_font_name                   TYPE /nag/excel_style_font_name OPTIONAL
        !ip_font_scheme                 TYPE /nag/excel_style_font_scheme OPTIONAL
        !ip_font_size                   TYPE /nag/excel_style_font_size OPTIONAL
        !ip_font_strikethrough          TYPE flag OPTIONAL
        !ip_font_underline              TYPE flag OPTIONAL
        !ip_font_underline_mode         TYPE /nag/excel_style_font_underline OPTIONAL
        !ip_fill_filltype               TYPE /nag/excel_fill_type OPTIONAL
        !ip_fill_rotation               TYPE /nag/excel_rotation OPTIONAL
        !ip_fill_fgcolor                TYPE /nag/excel_s_style_color OPTIONAL
        !ip_fill_fgcolor_rgb            TYPE /nag/excel_style_color_argb OPTIONAL
        !ip_fill_fgcolor_indexed        TYPE /nag/excel_style_color_indexed OPTIONAL
        !ip_fill_fgcolor_theme          TYPE /nag/excel_style_color_theme OPTIONAL
        !ip_fill_fgcolor_tint           TYPE /nag/excel_style_color_tint OPTIONAL
        !ip_fill_bgcolor                TYPE /nag/excel_s_style_color OPTIONAL
        !ip_fill_bgcolor_rgb            TYPE /nag/excel_style_color_argb OPTIONAL
        !ip_fill_bgcolor_indexed        TYPE /nag/excel_style_color_indexed OPTIONAL
        !ip_fill_bgcolor_theme          TYPE /nag/excel_style_color_theme OPTIONAL
        !ip_fill_bgcolor_tint           TYPE /nag/excel_style_color_tint OPTIONAL
        !ip_borders_allborders          TYPE /nag/excel_s_cstyle_border OPTIONAL
        !ip_fill_gradtype_type          TYPE /nag/excel_s_gradient_type-type OPTIONAL
        !ip_fill_gradtype_degree        TYPE /nag/excel_s_gradient_type-degree OPTIONAL
        !ip_xborders_allborders         TYPE /nag/excel_s_cstylex_border OPTIONAL
        !ip_borders_diagonal            TYPE /nag/excel_s_cstyle_border OPTIONAL
        !ip_fill_gradtype_bottom        TYPE /nag/excel_s_gradient_type-bottom OPTIONAL
        !ip_fill_gradtype_top           TYPE /nag/excel_s_gradient_type-top OPTIONAL
        !ip_xborders_diagonal           TYPE /nag/excel_s_cstylex_border OPTIONAL
        !ip_borders_diagonal_mode       TYPE /nag/excel_diagonal OPTIONAL
        !ip_fill_gradtype_right         TYPE /nag/excel_s_gradient_type-right OPTIONAL
        !ip_borders_down                TYPE /nag/excel_s_cstyle_border OPTIONAL
        !ip_fill_gradtype_left          TYPE /nag/excel_s_gradient_type-left OPTIONAL
        !ip_fill_gradtype_position1     TYPE /nag/excel_s_gradient_type-position1 OPTIONAL
        !ip_xborders_down               TYPE /nag/excel_s_cstylex_border OPTIONAL
        !ip_borders_left                TYPE /nag/excel_s_cstyle_border OPTIONAL
        !ip_fill_gradtype_position2     TYPE /nag/excel_s_gradient_type-position2 OPTIONAL
        !ip_fill_gradtype_position3     TYPE /nag/excel_s_gradient_type-position3 OPTIONAL
        !ip_xborders_left               TYPE /nag/excel_s_cstylex_border OPTIONAL
        !ip_borders_right               TYPE /nag/excel_s_cstyle_border OPTIONAL
        !ip_xborders_right              TYPE /nag/excel_s_cstylex_border OPTIONAL
        !ip_borders_top                 TYPE /nag/excel_s_cstyle_border OPTIONAL
        !ip_xborders_top                TYPE /nag/excel_s_cstylex_border OPTIONAL
        !ip_alignment_horizontal        TYPE /nag/excel_alignment OPTIONAL
        !ip_alignment_vertical          TYPE /nag/excel_alignment OPTIONAL
        !ip_alignment_textrotation      TYPE /nag/excel_text_rotation OPTIONAL
        !ip_alignment_wraptext          TYPE flag OPTIONAL
        !ip_alignment_shrinktofit       TYPE flag OPTIONAL
        !ip_alignment_indent            TYPE /nag/excel_indent OPTIONAL
        !ip_protection_hidden           TYPE /nag/excel_cell_protection OPTIONAL
        !ip_protection_locked           TYPE /nag/excel_cell_protection OPTIONAL
        !ip_borders_allborders_style    TYPE /nag/excel_border OPTIONAL
        !ip_borders_allborders_color    TYPE /nag/excel_s_style_color OPTIONAL
        !ip_borders_allbo_color_rgb     TYPE /nag/excel_style_color_argb OPTIONAL
        !ip_borders_allbo_color_indexed TYPE /nag/excel_style_color_indexed OPTIONAL
        !ip_borders_allbo_color_theme   TYPE /nag/excel_style_color_theme OPTIONAL
        !ip_borders_allbo_color_tint    TYPE /nag/excel_style_color_tint OPTIONAL
        !ip_borders_diagonal_style      TYPE /nag/excel_border OPTIONAL
        !ip_borders_diagonal_color      TYPE /nag/excel_s_style_color OPTIONAL
        !ip_borders_diagonal_color_rgb  TYPE /nag/excel_style_color_argb OPTIONAL
        !ip_borders_diagonal_color_inde TYPE /nag/excel_style_color_indexed OPTIONAL
        !ip_borders_diagonal_color_them TYPE /nag/excel_style_color_theme OPTIONAL
        !ip_borders_diagonal_color_tint TYPE /nag/excel_style_color_tint OPTIONAL
        !ip_borders_down_style          TYPE /nag/excel_border OPTIONAL
        !ip_borders_down_color          TYPE /nag/excel_s_style_color OPTIONAL
        !ip_borders_down_color_rgb      TYPE /nag/excel_style_color_argb OPTIONAL
        !ip_borders_down_color_indexed  TYPE /nag/excel_style_color_indexed OPTIONAL
        !ip_borders_down_color_theme    TYPE /nag/excel_style_color_theme OPTIONAL
        !ip_borders_down_color_tint     TYPE /nag/excel_style_color_tint OPTIONAL
        !ip_borders_left_style          TYPE /nag/excel_border OPTIONAL
        !ip_borders_left_color          TYPE /nag/excel_s_style_color OPTIONAL
        !ip_borders_left_color_rgb      TYPE /nag/excel_style_color_argb OPTIONAL
        !ip_borders_left_color_indexed  TYPE /nag/excel_style_color_indexed OPTIONAL
        !ip_borders_left_color_theme    TYPE /nag/excel_style_color_theme OPTIONAL
        !ip_borders_left_color_tint     TYPE /nag/excel_style_color_tint OPTIONAL
        !ip_borders_right_style         TYPE /nag/excel_border OPTIONAL
        !ip_borders_right_color         TYPE /nag/excel_s_style_color OPTIONAL
        !ip_borders_right_color_rgb     TYPE /nag/excel_style_color_argb OPTIONAL
        !ip_borders_right_color_indexed TYPE /nag/excel_style_color_indexed OPTIONAL
        !ip_borders_right_color_theme   TYPE /nag/excel_style_color_theme OPTIONAL
        !ip_borders_right_color_tint    TYPE /nag/excel_style_color_tint OPTIONAL
        !ip_borders_top_style           TYPE /nag/excel_border OPTIONAL
        !ip_borders_top_color           TYPE /nag/excel_s_style_color OPTIONAL
        !ip_borders_top_color_rgb       TYPE /nag/excel_style_color_argb OPTIONAL
        !ip_borders_top_color_indexed   TYPE /nag/excel_style_color_indexed OPTIONAL
        !ip_borders_top_color_theme     TYPE /nag/excel_style_color_theme OPTIONAL
        !ip_borders_top_color_tint      TYPE /nag/excel_style_color_tint OPTIONAL
      RETURNING
    ...
    METHODS constructor
      IMPORTING
        !ip_excel TYPE REF TO /nag/cl_excel
        !ip_title TYPE /nag/excel_sheet_title OPTIONAL
      RAISING
        /nag/cx_excel .
    METHODS delete_merge
      IMPORTING
        !ip_cell_column TYPE simple OPTIONAL
        !ip_cell_row    TYPE /nag/excel_cell_row OPTIONAL
      RAISING
        /nag/cx_excel .
    ...
    METHODS get_cell
      IMPORTING
        ...
        !ip_row       TYPE /nag/excel_cell_row OPTIONAL
      EXPORTING
        !ep_value     TYPE /nag/excel_cell_value
        !ep_rc        TYPE sysubrc
        !ep_style     TYPE REF TO /nag/cl_excel_style
        !ep_guid      TYPE /nag/excel_cell_style
        !ep_formula   TYPE /nag/excel_cell_formula
        !et_rtf       TYPE /nag/excel_t_rtf
      RAISING
        /nag/cx_excel .
    METHODS get_column
      IMPORTING
    ...
    METHODS get_columns
      RETURNING
        VALUE(eo_columns) TYPE REF TO /nag/cl_excel_columns
      RAISING
        /nag/cx_excel .
    ...
    METHODS get_default_excel_date_format
      RETURNING
        VALUE(ep_default_excel_date_format) TYPE /nag/excel_number_format .
    METHODS get_default_excel_time_format
      RETURNING
        VALUE(ep_default_excel_time_format) TYPE /nag/excel_number_format .
    ...
    METHODS get_comments
      RETURNING
        VALUE(r_comments) TYPE REF TO /nag/cl_excel_comments .
    METHODS get_drawings
      IMPORTING
        !ip_type          TYPE /nag/excel_drawing_type OPTIONAL
      RETURNING
        VALUE(r_drawings) TYPE REF TO /nag/cl_excel_drawings .
    METHODS get_comments_iterator
      RETURNING
        VALUE(eo_iterator) TYPE REF TO /nag/cl_excel_collection_iterator .
    METHODS get_drawings_iterator
      IMPORTING
        !ip_type           TYPE /nag/excel_drawing_type
      RETURNING
        VALUE(eo_iterator) TYPE REF TO /nag/cl_excel_collection_iterator .
    METHODS get_freeze_cell
      EXPORTING
        !ep_row    TYPE /nag/excel_cell_row
        !ep_column TYPE /nag/excel_cell_column .
    METHODS get_guid
      RETURNING
        VALUE(ep_guid) TYPE sysuuid_x16 .
    METHODS get_highest_column
      RETURNING
        VALUE(r_highest_column) TYPE /nag/excel_cell_column
      RAISING
        /nag/cx_excel .
    ...
    METHODS get_pagebreaks
      RETURNING
        VALUE(ro_pagebreaks) TYPE REF TO /nag/cl_excel_worksheet_pagebreaks
      RAISING
        /nag/cx_excel .
    ...
    METHODS get_rows
      RETURNING
        VALUE(eo_rows) TYPE REF TO /nag/cl_excel_rows .
    ...
    METHODS get_style_cond
      IMPORTING
        !ip_guid             TYPE /nag/excel_cell_style
      RETURNING
        VALUE(eo_style_cond) TYPE REF TO /nag/cl_excel_style_cond .
    METHODS get_tabcolor
      RETURNING
        VALUE(ev_tabcolor) TYPE /nag/excel_s_tabcolor .
    ...
    METHODS get_title
      ...
      RETURNING
        VALUE(ep_title) TYPE /nag/excel_sheet_title .
    ...
    METHODS set_cell
      IMPORTING
        ...
        !ip_formula           TYPE /nag/excel_cell_formula OPTIONAL
        !ip_style             TYPE any OPTIONAL
        !ip_hyperlink         TYPE REF TO /nag/cl_excel_hyperlink OPTIONAL
        !ip_data_type         TYPE /nag/excel_cell_data_type OPTIONAL
        !ip_abap_type         TYPE abap_typekind OPTIONAL
        !ip_currency          TYPE waers_curc OPTIONAL
        !it_rtf               TYPE /nag/excel_t_rtf OPTIONAL
    ...
    METHODS set_cell_formula
      IMPORTING
        ...
        !ip_column    TYPE simple OPTIONAL
        !ip_row       TYPE /nag/excel_cell_row OPTIONAL
        !ip_formula   TYPE /nag/excel_cell_formula
      RAISING
        /nag/cx_excel .
    ...
    METHODS set_default_excel_date_format
      IMPORTING
        !ip_default_excel_date_format TYPE /nag/excel_number_format
      RAISING
        /nag/cx_excel .
    ...
    METHODS set_merge
      IMPORTING
        ...
        !ip_formula      TYPE /nag/excel_cell_formula OPTIONAL        "added parameter
      RAISING
        /nag/cx_excel .
    ...
    METHODS set_print_gridlines
      IMPORTING
        !i_print_gridlines TYPE /nag/excel_print_gridlines .
    ...
    METHODS set_show_gridlines
      IMPORTING
        !i_show_gridlines TYPE /nag/excel_show_gridlines .
    METHODS set_show_rowcolheaders
      IMPORTING
        !i_show_rowcolheaders TYPE /nag/excel_show_rowcolheader .
    METHODS set_tabcolor
      IMPORTING
        !iv_tabcolor TYPE /nag/excel_s_tabcolor .
    METHODS set_table
      IMPORTING
        !ip_table           TYPE STANDARD TABLE
        ...
        !ip_top_left_column TYPE /nag/excel_cell_column_alpha DEFAULT 'B'
        !ip_top_left_row    TYPE /nag/excel_cell_row DEFAULT 3
    ...
    METHODS set_title
      IMPORTING
        !ip_title TYPE /nag/excel_sheet_title
      RAISING
        /nag/cx_excel .
    METHODS get_table
      IMPORTING
    ...
    METHODS get_header_footer_drawings
      RETURNING
        VALUE(rt_drawings) TYPE /nag/excel_t_drawings .
  ...
  PROTECTED SECTION.
    METHODS set_table_reference
      IMPORTING
        !ip_column    TYPE /nag/excel_cell_column
        !ip_row       TYPE /nag/excel_cell_row
        !ir_table     TYPE REF TO /nag/cl_excel_table
        !ip_fieldname TYPE /nag/excel_fieldname
        !ip_header    TYPE abap_bool
      RAISING
        /nag/cx_excel .
  PRIVATE SECTION.

*"* private components of class /NAG/CL_EXCEL_WORKSHEET
*"* do not include other source files here!!!
    TYPES ty_table_settings TYPE STANDARD TABLE OF /nag/excel_s_table_settings WITH DEFAULT KEY.
    DATA active_cell TYPE /nag/excel_s_cell_data .
    DATA charts TYPE REF TO /nag/cl_excel_drawings .
    DATA columns TYPE REF TO /nag/cl_excel_columns .
    DATA row_default TYPE REF TO /nag/cl_excel_row .
    DATA column_default TYPE REF TO /nag/cl_excel_column .
    DATA styles_cond TYPE REF TO /nag/cl_excel_styles_cond .
    DATA data_validations TYPE REF TO /nag/cl_excel_data_validations .
    DATA default_excel_date_format TYPE /nag/excel_number_format .
    DATA default_excel_time_format TYPE /nag/excel_number_format .
    DATA comments TYPE REF TO /nag/cl_excel_comments .
    DATA drawings TYPE REF TO /nag/cl_excel_drawings .
    DATA freeze_pane_cell_column TYPE /nag/excel_cell_column .
    DATA freeze_pane_cell_row TYPE /nag/excel_cell_row .
    DATA guid TYPE sysuuid_x16 .
    DATA hyperlinks TYPE REF TO /nag/cl_excel_collection .
    DATA lower_cell TYPE /nag/excel_s_cell_data .
    DATA mo_pagebreaks TYPE REF TO /nag/cl_excel_worksheet_pagebreaks .
    DATA mt_row_outlines TYPE mty_ts_outlines_row .
    DATA print_title_col_from TYPE /nag/excel_cell_column_alpha .
    DATA print_title_col_to TYPE /nag/excel_cell_column_alpha .
    DATA print_title_row_from TYPE /nag/excel_cell_row .
    DATA print_title_row_to TYPE /nag/excel_cell_row .
    DATA ranges TYPE REF TO /nag/cl_excel_ranges .
    DATA rows TYPE REF TO /nag/cl_excel_rows .
    DATA tables TYPE REF TO /nag/cl_excel_collection .
    DATA title TYPE /nag/excel_sheet_title VALUE 'Worksheet'. "#EC NOTEXT .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  . " .
    DATA upper_cell TYPE /nag/excel_s_cell_data .
    ...
    CLASS-METHODS calculate_table_bottom_right
      IMPORTING
        ip_table         TYPE STANDARD TABLE
        it_field_catalog TYPE /nag/excel_t_fieldcatalog
      CHANGING
        cs_settings      TYPE /nag/excel_s_table_settings
      RAISING
        /nag/cx_excel.
    ...
    METHODS check_rtf
      IMPORTING
        !ip_value       TYPE simple
        VALUE(ip_style) TYPE /nag/excel_cell_style OPTIONAL
      CHANGING
        !ct_rtf         TYPE /nag/excel_t_rtf
      RAISING
        /nag/cx_excel .
    CLASS-METHODS check_table_overlapping
      IMPORTING
        is_table_settings       TYPE /nag/excel_s_table_settings
        it_other_table_settings TYPE ty_table_settings
      RAISING
        /nag/cx_excel.
    METHODS clear_initial_colorxfields
      IMPORTING
        is_color  TYPE /nag/excel_s_style_color
      CHANGING
        cs_xcolor TYPE /nag/excel_s_cstylex_color.
    ...
    METHODS move_supplied_borders
      IMPORTING
        ...
        is_border                 TYPE /nag/excel_s_cstyle_border
        iv_xborder_supplied       TYPE abap_bool
        is_xborder                TYPE /nag/excel_s_cstylex_border
      CHANGING
        cs_complete_style_border  TYPE /nag/excel_s_cstyle_border
        cs_complete_stylex_border TYPE /nag/excel_s_cstylex_border.
    METHODS normalize_column_heading_texts
      IMPORTING
        iv_default_descr TYPE c
        it_field_catalog TYPE /nag/excel_t_fieldcatalog
      RETURNING
        VALUE(result)    TYPE /nag/excel_t_fieldcatalog.
    ...
    METHODS normalize_range_parameter
      IMPORTING
        ...
        ip_row_to       TYPE /nag/excel_cell_row OPTIONAL
      EXPORTING
        ep_column_start TYPE /nag/excel_cell_column
        ep_column_end   TYPE /nag/excel_cell_column
        ep_row          TYPE /nag/excel_cell_row
        ep_row_to       TYPE /nag/excel_cell_row
      RAISING
        /nag/cx_excel.
    CLASS-METHODS normalize_style_parameter
      ...
      RETURNING
        VALUE(rv_guid)    TYPE /nag/excel_cell_style
      RAISING
        /nag/cx_excel .
...
CLASS /nag/cl_excel_worksheet IMPLEMENTATION.
  ...
  METHOD add_drawing.
    CASE ip_drawing->get_type( ).
      WHEN /nag/cl_excel_drawing=>type_image.
        drawings->include( ip_drawing ).
      WHEN /nag/cl_excel_drawing=>type_chart.
  ...
  METHOD add_new_column.
    DATA: lv_column_alpha TYPE /nag/excel_cell_column_alpha.

    lv_column_alpha = /nag/cl_excel_common=>convert_column2alpha( ip_column ).
...
* Create default blank range
  ...
  METHOD bind_alv.
    DATA: lo_converter TYPE REF TO /nag/cl_excel_converter.
  ...
  METHOD bind_alv_ole2.
    ...
    CALL METHOD ('/NAG/CL_EXCEL_OLE')=>('BIND_ALV_OLE2')
      EXPORTING
...
*--------------------------------------------------------------------*
    ...
    CONSTANTS:
      lc_top_left_column TYPE /nag/excel_cell_column_alpha VALUE 'A',
      lc_top_left_row    TYPE /nag/excel_cell_row VALUE 1,
      lc_no_currency     TYPE waers_curc VALUE IS INITIAL.

    DATA:
      lv_row_int              TYPE /nag/excel_cell_row,
      lv_first_row            TYPE /nag/excel_cell_row,
      lv_last_row             TYPE /nag/excel_cell_row,
      lv_column_int           TYPE /nag/excel_cell_column,
      lv_column_alpha         TYPE /nag/excel_cell_column_alpha,
      lt_field_catalog        TYPE /nag/excel_t_fieldcatalog,
      lv_id                   TYPE i,
      lv_formula              TYPE string,
      ls_settings             TYPE /nag/excel_s_table_settings,
      lo_table                TYPE REF TO /nag/cl_excel_table,
      lv_value_lowercase      TYPE string,
      lv_syindex              TYPE c LENGTH 3,
      lo_iterator             TYPE REF TO /nag/cl_excel_collection_iterator,
      lo_style_cond           TYPE REF TO /nag/cl_excel_style_cond,
      lo_curtable             TYPE REF TO /nag/cl_excel_table,
      lt_other_table_settings TYPE ty_table_settings.
    DATA: ls_column_formula TYPE mty_s_column_formula,
          lv_mincol         TYPE i.

    FIELD-SYMBOLS:
      <ls_field_catalog>        TYPE /nag/excel_s_fieldcatalog,
      <ls_field_catalog_custom> TYPE /nag/excel_s_fieldcatalog,
    ...
    IF ls_settings-table_style IS INITIAL.
      ls_settings-table_style = /nag/cl_excel_table=>builtinstyle_medium2.
    ENDIF.
    ...
    IF it_field_catalog IS NOT SUPPLIED.
      lt_field_catalog = /nag/cl_excel_common=>get_fieldcatalog( ip_table = ip_table
...
* Start filling the table
    ...
    lv_column_int = /nag/cl_excel_common=>convert_column2int( ls_settings-top_left_column ).
...
* It is better to loop column by column (only visible column)
    LOOP AT lt_field_catalog ASSIGNING <ls_field_catalog> WHERE dynpfld EQ abap_true.
      ...
      lv_column_alpha = /nag/cl_excel_common=>convert_column2alpha( lv_column_int ).
      ...
      IF <ls_field_catalog>-column_formula IS NOT INITIAL.
        ...
        ls_column_formula-table_right_column_int = /nag/cl_excel_common=>convert_column2int( lo_table->settings-bottom_right_column ).
...
*--------------------------------------------------------------------*
    ...
    DATA: ld_cell_value                TYPE /nag/excel_cell_value,
          ld_style_guid                TYPE /nag/excel_cell_style,
          ls_stylemapping              TYPE /nag/excel_s_stylemapping,
          lo_table_object              TYPE REF TO object,
          lo_table                     TYPE REF TO /nag/cl_excel_table,
          ld_table_top_left_column     TYPE /nag/excel_cell_column,
          ld_table_bottom_right_column TYPE /nag/excel_cell_column,
          ...
          ld_font_height               TYPE tdfontsize VALUE /nag/cl_excel_font=>lc_default_font_height,
          ld_font_name                 TYPE /nag/excel_style_font_name VALUE /nag/cl_excel_font=>lc_default_font_name.
    ...
    IF ld_style_guid IS NOT INITIAL.
      TRY.
          ...
          IF ls_stylemapping-complete_style-number_format-format_code =
             /nag/cl_excel_style_number_format=>c_format_date_std.

            " Convert excel date to ABAP date
            ld_date =
              /nag/cl_excel_common=>excel_string_to_date( ld_cell_value ).
        ...
        CATCH /nag/cx_excel.                                "#EC NO_HANDLER
    ...
    ep_width = /nag/cl_excel_font=>calculate_text_width(
  ...
  METHOD calculate_column_widths.
    ...
    DATA: lo_column_iterator TYPE REF TO /nag/cl_excel_collection_iterator,
          lo_column          TYPE REF TO /nag/cl_excel_column.
...
* Do not check merged cells
  ...
  METHOD calculate_table_bottom_right.
    ...
    DATA: lv_errormessage TYPE string,
          lv_columns      TYPE i,
          lt_columns      TYPE /nag/excel_t_fieldcatalog,
          lv_maxrow       TYPE i,
          lo_iterator     TYPE REF TO /nag/cl_excel_collection_iterator,
          lo_curtable     TYPE REF TO /nag/cl_excel_table,
          lv_row_int      TYPE /nag/excel_cell_row,
    ...
    lv_column_int = /nag/cl_excel_common=>convert_column2int( cs_settings-top_left_column ).
    ...
    cs_settings-bottom_right_column = /nag/cl_excel_common=>convert_column2alpha( lv_maxcol ).
  ...
  METHOD change_area_style.
    ...
    DATA: lv_row              TYPE /nag/excel_cell_row,
          lv_row_start        TYPE /nag/excel_cell_row,
          lv_row_to           TYPE /nag/excel_cell_row,
          lv_column_int       TYPE /nag/excel_cell_column,
          lv_column_start_int TYPE /nag/excel_cell_column,
          lv_column_end_int   TYPE /nag/excel_cell_column.
  ...
  METHOD change_cell_style.
    ...
    DATA: changer TYPE REF TO /nag/if_excel_style_changer,
          column  TYPE /nag/excel_cell_column,
          row     TYPE /nag/excel_cell_row.
    ...
    changer = /nag/cl_excel_style_changer=>create( excel = excel ).


    IF ip_complete IS SUPPLIED.
      IF ip_xcomplete IS NOT SUPPLIED.
        /nag/cx_excel=>raise_text( 'Complete styleinfo has to be supplied with corresponding X-field' ).
      ENDIF.
  ...
  METHOD check_cell_column_formula.
    ...
    FIELD-SYMBOLS <fs_column_formula> TYPE /nag/cl_excel_worksheet=>mty_s_column_formula.

    IF ip_value IS NOT INITIAL OR ip_formula IS NOT INITIAL.
      /nag/cx_excel=>raise_text( c_messages-formula_id_only_is_possible ).
    ENDIF.
    READ TABLE it_column_formulas WITH TABLE KEY id = ip_column_formula_id ASSIGNING <fs_column_formula>.
    IF sy-subrc <> 0.
      /nag/cx_excel=>raise_text( c_messages-column_formula_id_not_found ).
    ENDIF.
    IF ip_row < <fs_column_formula>-table_top_left_row + 1
      ...
      /nag/cx_excel=>raise_text( c_messages-formula_not_in_this_table ).
    ENDIF.
    IF ip_column <> <fs_column_formula>-column.
      /nag/cx_excel=>raise_text( c_messages-formula_in_other_column ).
    ENDIF.
  ...
  METHOD check_rtf.
    ...
    DATA: lo_style           TYPE REF TO /nag/cl_excel_style,
          lo_iterator        TYPE REF TO /nag/cl_excel_collection_iterator,
  ...
  METHOD check_table_overlapping.
    ...
    DATA: lv_errormessage TYPE string,
          ...
          lv_maxcol       TYPE i.
    FIELD-SYMBOLS:
          <ls_table_settings> TYPE /nag/excel_s_table_settings.

    lv_column_int = /nag/cl_excel_common=>convert_column2int( is_table_settings-top_left_column ).
    lv_maxcol = /nag/cl_excel_common=>convert_column2int( is_table_settings-bottom_right_column ).
    ...
    LOOP AT it_other_table_settings ASSIGNING <ls_table_settings>.
      ...
      IF  (    (  is_table_settings-top_left_row     GE <ls_table_settings>-top_left_row
        ...
        AND
          (    (  lv_column_int GE /nag/cl_excel_common=>convert_column2int( <ls_table_settings>-top_left_column )
              AND lv_column_int LE /nag/cl_excel_common=>convert_column2int( <ls_table_settings>-bottom_right_column ) )
            OR
               (  lv_maxcol     GE /nag/cl_excel_common=>convert_column2int( <ls_table_settings>-top_left_column )
              AND lv_maxcol     LE /nag/cl_excel_common=>convert_column2int( <ls_table_settings>-bottom_right_column ) )
          ).
        lv_errormessage = 'Table overlaps with previously bound table and will not be added to worksheet.'(400).
        /nag/cx_excel=>raise_text( lv_errormessage ).
      ENDIF.
  ...
  METHOD constructor.
    DATA: lv_title TYPE /nag/excel_sheet_title.

    me->excel = ip_excel.

    me->guid = /nag/cl_excel_obsolete_func_wrap=>guid_create( ).        " ins issue #379 - replacement for outdated function call
    ...
    CREATE OBJECT drawings
      EXPORTING
        ip_type = /nag/cl_excel_drawing=>type_image.
    CREATE OBJECT charts
      EXPORTING
        ip_type = /nag/cl_excel_drawing=>type_chart.
    me->/nag/if_excel_sheet_protection~initialize( ).
    me->/nag/if_excel_sheet_properties~initialize( ).
  ...
  METHOD convert_to_table.
    ...
    TYPES:
      ...
      BEGIN OF ts_style_conv,
        cell_style TYPE /nag/excel_s_cell_data-cell_style,
    ...
    DATA:
      ...
      ls_stylemapping     TYPE /nag/excel_s_stylemapping,
      lv_format_code      TYPE /nag/excel_number_format,
      lv_float            TYPE f,
    ...
    FIELD-SYMBOLS:
      ...
      <ls_ddic_object>   TYPE x031l,
      <ls_sheet_content> TYPE /nag/excel_s_cell_data,
    ...
    IF lt_field_catalog IS INITIAL.
      IF et_data IS SUPPLIED.
        lt_field_catalog = /nag/cl_excel_common=>get_fieldcatalog( ip_table = et_data ).
      ELSE.
        DO lv_maxcol TIMES.
...
*      lt_ddic_object = get_ddic_object( et_data ).
    ...
    IF lt_style_conv IS NOT INITIAL.
      ...
      LOOP AT lt_style_conv INTO ls_style_conv.
        ...
        IF lv_format_code CA 'yd' OR lv_format_code EQ /nag/cl_excel_style_number_format=>c_format_date_std.
          " DATE = yyyymmdd
          ...
          IF sy-subrc EQ 0 AND <ls_field_conv>-convexit IS NOT INITIAL.
            CASE <ls_field_conv>-convexit.
              WHEN cl_abap_typedescr=>typekind_float.
                lv_float = /nag/cl_excel_common=>excel_string_to_number( <ls_sheet_content>-cell_value ).
            ...
            IF sy-subrc EQ 0.
              CASE ls_style_conv-abap_type.
                WHEN cl_abap_typedescr=>typekind_date.
                  <lv_data> = /nag/cl_excel_common=>excel_string_to_date( <ls_sheet_content>-cell_value ).
                WHEN cl_abap_typedescr=>typekind_time.
                  <lv_data> = /nag/cl_excel_common=>excel_string_to_time( <ls_sheet_content>-cell_value ).
              ENDCASE.
            ENDIF.
          ENDIF.
...
*--------------------------------------------------------------------*
    ...
    ELSE.
      lv_column = /nag/cl_excel_common=>convert_column2int( ip_cell_column ).
  ...
  METHOD delete_row_outline.
    ...
    IF sy-subrc <> 0.  " didn't find outline that was to be deleted
      /nag/cx_excel=>raise_text( 'Row outline to be deleted does not exist' ).
    ENDIF.
  ...
  METHOD freeze_panes.
    ...
    IF ip_num_columns IS NOT SUPPLIED AND ip_num_rows IS NOT SUPPLIED.
      /nag/cx_excel=>raise_text( 'Pleas provide number of rows and/or columns to freeze' ).
    ENDIF.

    IF ip_num_columns IS SUPPLIED AND ip_num_columns <= 0.
      /nag/cx_excel=>raise_text( 'Number of columns to freeze should be positive' ).
    ENDIF.

    IF ip_num_rows IS SUPPLIED AND ip_num_rows <= 0.
      /nag/cx_excel=>raise_text( 'Number of rows to freeze should be positive' ).
    ENDIF.
  ...
  METHOD generate_title.
    DATA: lo_worksheets_iterator TYPE REF TO /nag/cl_excel_collection_iterator,
          lo_worksheet           TYPE REF TO /nag/cl_excel_worksheet.

    DATA: t_titles    TYPE HASHED TABLE OF /nag/excel_sheet_title WITH UNIQUE KEY table_line,
          title       TYPE /nag/excel_sheet_title,
          sheetnumber TYPE i.
...
* Now build sheetnumber.  Increase counter until we hit a number that is not used so far
  ...
  METHOD get_active_cell.
    ...
    DATA: lv_active_column TYPE /nag/excel_cell_column_alpha,
          lv_active_row    TYPE string.

    lv_active_column = /nag/cl_excel_common=>convert_column2alpha( active_cell-cell_column ).
  ...
  METHOD get_cell.
    ...
    DATA: lv_column        TYPE /nag/excel_cell_column,
          lv_row           TYPE /nag/excel_cell_row,
          ls_sheet_content TYPE /nag/excel_s_cell_data.
    ...
    DATA: style_iterator TYPE REF TO /nag/cl_excel_collection_iterator,
          style          TYPE REF TO /nag/cl_excel_style.
  ...
  METHOD get_column.
    ...
    lv_column = /nag/cl_excel_common=>convert_column2int( ip_column ).
  ...
  METHOD get_columns.
    ...
    DATA: columns TYPE TABLE OF i,
          column  TYPE i.
    FIELD-SYMBOLS:
          <sheet_cell> TYPE /nag/excel_s_cell_data.
  ...
  METHOD get_comments.
    DATA: lo_comment  TYPE REF TO /nag/cl_excel_comment,
          lo_iterator TYPE REF TO /nag/cl_excel_collection_iterator.
  ...
  METHOD get_default_excel_date_format.
    ...
    IF default_excel_date_format IS INITIAL.
      default_excel_date_format = /nag/cl_excel_style_number_format=>c_format_date_ddmmyyyydot.
    ENDIF.
...
*0  24 Hour Format (Example: 12:05:10)
        default_excel_time_format = /nag/cl_excel_style_number_format=>c_format_date_time6.
      WHEN 1.
*1  12 Hour Format (Example: 12:05:10 PM)
        default_excel_time_format = /nag/cl_excel_style_number_format=>c_format_date_time2.
      WHEN 2.
...
*4  Hours from 0 to 11 (Example: 00:05:10 pm)  for now all the same. no chnage upper lower
  ...
  METHOD get_drawings.
    ...
    DATA: lo_drawing  TYPE REF TO /nag/cl_excel_drawing,
          lo_iterator TYPE REF TO /nag/cl_excel_collection_iterator.
  ...
  METHOD get_header_footer_drawings.
    DATA: ls_odd_header  TYPE /nag/excel_s_worksheet_head_foot,
          ls_odd_footer  TYPE /nag/excel_s_worksheet_head_foot,
          ls_even_header TYPE /nag/excel_s_worksheet_head_foot,
          ls_even_footer TYPE /nag/excel_s_worksheet_head_foot,
          ls_hd_ft       TYPE /nag/excel_s_worksheet_head_foot.

    FIELD-SYMBOLS: <fs_drawings> TYPE /nag/excel_s_drawings.
...
*** Even footer
  ...
  METHOD get_merge.
    ...
    LOOP AT me->mt_merged_cells ASSIGNING <ls_merged_cell>.
      ...
      lv_col_from = /nag/cl_excel_common=>convert_column2alpha( <ls_merged_cell>-col_from ).
      lv_col_to   = /nag/cl_excel_common=>convert_column2alpha( <ls_merged_cell>-col_to   ).
  ...
  METHOD get_rows.
    ...
    DATA: row TYPE i.
    FIELD-SYMBOLS: <sheet_cell> TYPE /nag/excel_s_cell_data.
  ...
  METHOD get_style_cond.
    ...
    DATA: lo_style_iterator TYPE REF TO /nag/cl_excel_collection_iterator,
          lo_style_cond     TYPE REF TO /nag/cl_excel_style_cond.
...
* CL_EXCEL_READER_2007->/NAG/IF_EXCEL_READER~LOAD_FILE()
*--------------------------------------------------------------------*
    ...
    DATA lv_errormessage TYPE string.
    DATA lv_max_col TYPE /nag/excel_cell_column.
    DATA lv_max_row TYPE int4.
    DATA lv_delta_col TYPE int4.
    DATA lv_value  TYPE /nag/excel_cell_value.
...
*--------------------------------------------------------------------*
              ...
              WHILE lv_actual_col <= lv_max_col.
                ...
                TRY.
                    ...
                    IF lv_type = 'D'.
                      <lv_value> = /nag/cl_excel_common=>excel_string_to_date( ip_value = lv_value ).
                    ELSE.
...
*  CATCH /nag/cx_excel.    "
  ...
  METHOD get_title.
    ...
    IF ip_escaped EQ abap_true.
      lv_value = me->title.
      ep_title = /nag/cl_excel_common=>escape_string( lv_value ).
    ELSE.
      ep_title = me->title.
    ENDIF.
  ENDMETHOD.                    "GET_TITLE
...
* We need to convert with output conversion function
  ...
  METHOD move_supplied_borders.
    ...
    DATA: ls_borderx TYPE /nag/excel_s_cstylex_border.
  ...
  METHOD normalize_column_heading_texts.
    ...
    DATA: lt_field_catalog      TYPE /nag/excel_t_fieldcatalog,
          lv_value_lowercase    TYPE string,
          lv_scrtext_l_initial  TYPE /nag/excel_column_name,
    ...
    FIELD-SYMBOLS: <ls_field_catalog> TYPE /nag/excel_s_fieldcatalog,
                   <scrtxt1>          TYPE any,
                   <scrtxt2>          TYPE any,
                   <scrtxt3>          TYPE any.
  ...
  METHOD normalize_columnrow_parameter.
    ...
    IF ip_columnrow IS NOT INITIAL.
      /nag/cl_excel_common=>convert_columnrow2column_a_row(
        EXPORTING
        ...
        IMPORTING
          ...
          e_row        = ep_row ).
    ELSE.
      ep_column = /nag/cl_excel_common=>convert_column2int( ip_column ).
      ep_row    = ip_row.
    ENDIF.
  ...
  METHOD normalize_range_parameter.
    ...
    IF ip_range IS NOT INITIAL.
      /nag/cl_excel_common=>convert_range2column_a_row(
        EXPORTING
          i_range            = ip_range
        IMPORTING
    ...
    ELSE.
      IF ip_column_start IS INITIAL.
        ep_column_start = /nag/cl_excel_common=>c_excel_sheet_min_col.
      ELSE.
        ep_column_start = /nag/cl_excel_common=>convert_column2int( ip_column_start ).
      ENDIF.
      IF ip_column_end IS INITIAL.
        ep_column_end = ep_column_start.
      ELSE.
        ep_column_end = /nag/cl_excel_common=>convert_column2int( ip_column_end ).
      ENDIF.
      ep_row = ip_row.
      IF ep_row IS INITIAL.
        ep_row = /nag/cl_excel_common=>c_excel_sheet_min_row.
      ENDIF.
      ep_row_to = ip_row_to.
  ...
  METHOD normalize_style_parameter.
    ...
    IF lo_style_type->type_kind = lo_style_type->typekind_oref.
      ...
      IF lo_style_type->absolute_name = '\CLASS=/NAG/CL_EXCEL_STYLE'.
        ASSIGN ip_style_or_guid TO <style>.
        rv_guid = <style>->get_guid( ).
      ENDIF.

    ELSEIF lo_style_type->absolute_name = '\TYPE=/NAG/EXCEL_CELL_STYLE'.
    ...
    ELSE.
      RAISE EXCEPTION TYPE /nag/cx_excel EXPORTING error = 'IP_GUID type must be either REF TO /nag/cl_excel_style or /nag/excel_cell_style'.
    ENDIF.
...
*--------------------------------------------------------------------*
    ...
    DATA: lo_range_iterator         TYPE REF TO /nag/cl_excel_collection_iterator,
          lo_range                  TYPE REF TO /nag/cl_excel_range,
...
*--------------------------------------------------------------------*
    ...
    WHILE lo_range_iterator->has_next( ) = abap_true.
      ...
      IF lo_range->name = /nag/if_excel_sheet_printsettings=>gcv_print_title_name.
        EXIT.  " Found it
      ENDIF.
      CLEAR lo_range.
...
*--------------------------------------------------------------------*
      IF lo_range IS NOT BOUND.
        ...
        lo_range->name = /nag/if_excel_sheet_printsettings=>gcv_print_title_name.
      ENDIF.

      lv_repeat_range_sheetname = me->get_title( ).
      lv_repeat_range_sheetname = /nag/cl_excel_common=>escape_string( lv_repeat_range_sheetname ).
...
*--------------------------------------------------------------------*
  ...
  METHOD set_area.
    ...
    DATA: lv_row              TYPE /nag/excel_cell_row,
          lv_row_start        TYPE /nag/excel_cell_row,
          lv_row_end          TYPE /nag/excel_cell_row,
          lv_column_int       TYPE /nag/excel_cell_column,
          lv_column           TYPE /nag/excel_cell_column_alpha,
          lv_column_start_int TYPE /nag/excel_cell_column,
          lv_column_end_int   TYPE /nag/excel_cell_column.
    ...
    ELSE.
      ...
      WHILE lv_column_int <= lv_column_end_int.
        ...
        lv_column = /nag/cl_excel_common=>convert_column2alpha( lv_column_int ).
        lv_row = lv_row_start.
  ...
  METHOD set_area_formula.
    DATA: ld_row              TYPE /nag/excel_cell_row,
          ld_row_start        TYPE /nag/excel_cell_row,
          ld_row_end          TYPE /nag/excel_cell_row,
          ld_column           TYPE /nag/excel_cell_column_alpha,
          ld_column_int       TYPE /nag/excel_cell_column,
          ld_column_start_int TYPE /nag/excel_cell_column,
          ld_column_end_int   TYPE /nag/excel_cell_column.
    ...
    ELSE.
      ...
      WHILE ld_column_int <= ld_column_end_int.
        ...
        ld_column = /nag/cl_excel_common=>convert_column2alpha( ld_column_int ).
        ld_row = ld_row_start.
  ...
  METHOD set_area_hyperlink.
    DATA: ld_row_start        TYPE /nag/excel_cell_row,
          ld_row_end          TYPE /nag/excel_cell_row,
          ld_column_int       TYPE /nag/excel_cell_column,
          ld_column_start_int TYPE /nag/excel_cell_column,
          ld_column_end_int   TYPE /nag/excel_cell_column,
          ld_current_column   TYPE /nag/excel_cell_column_alpha,
          ld_current_row      TYPE /nag/excel_cell_row,
          ld_value            TYPE string,
          ld_formula          TYPE string.
    DATA: lo_hyperlink TYPE REF TO /nag/cl_excel_hyperlink.
    ...
    ld_column_int = ld_column_start_int.
    WHILE ld_column_int <= ld_column_end_int.
      ld_current_column = /nag/cl_excel_common=>convert_column2alpha( ld_column_int ).
      ...
      WHILE ld_current_row <= ld_row_end.
        ...
        IF ip_is_internal = abap_true.
          lo_hyperlink = /nag/cl_excel_hyperlink=>create_internal_link( iv_location = ip_url ).
        ELSE.
          lo_hyperlink = /nag/cl_excel_hyperlink=>create_external_link( iv_url = ip_url ).
        ENDIF.
  ...
  METHOD set_cell.
    ...
    DATA: lv_column        TYPE /nag/excel_cell_column,
          ls_sheet_content TYPE /nag/excel_s_cell_data,
          lv_row           TYPE /nag/excel_cell_row,
          lv_value         TYPE /nag/excel_cell_value,
          lv_data_type     TYPE /nag/excel_cell_data_type,
          lv_value_type    TYPE abap_typekind,
          lv_style_guid    TYPE /nag/excel_cell_style,
          lo_addit         TYPE REF TO cl_abap_elemdescr,
          lt_rtf           TYPE /nag/excel_t_rtf,
          lo_value         TYPE REF TO data,
          lo_value_new     TYPE REF TO data.

    FIELD-SYMBOLS: <fs_sheet_content> TYPE /nag/excel_s_cell_data,
    ...
    FIELD-SYMBOLS: <ls_fieldcat>       TYPE /nag/excel_s_fieldcatalog.

    IF ip_value  IS NOT SUPPLIED
        AND ip_formula IS NOT SUPPLIED
        AND ip_column_formula_id = 0.
      /nag/cx_excel=>raise_text( 'Please provide the value or formula' ).
    ENDIF.
      ...
      ELSE.
        ...
        CASE lv_value_type.
          WHEN cl_abap_typedescr=>typekind_int OR cl_abap_typedescr=>typekind_int1 OR cl_abap_typedescr=>typekind_int2
            ...
            IF sy-subrc = 0.
              <fs_numeric> = <fs_value>.
              lv_value = /nag/cl_excel_common=>number_to_excel_string( ip_value = <fs_numeric> ).
            ENDIF.
          ...
          WHEN cl_abap_typedescr=>typekind_float OR cl_abap_typedescr=>typekind_packed OR
            ...
            IF lv_value_type = cl_abap_typedescr=>typekind_packed
              ...
              lv_value = /nag/cl_excel_common=>number_to_excel_string( ip_value    = <fs_value>
          ...
          WHEN cl_abap_typedescr=>typekind_date.
            ...
            IF sy-subrc = 0.
              <fs_date> = <fs_value>.
              lv_value = /nag/cl_excel_common=>date_to_excel_string( ip_value = <fs_date> ) .
            ENDIF.
* Begin of change issue #152 - don't touch exisiting style if only value is passed
...
* End of change issue #152 - don't touch exisiting style if only value is passed
          ...
          WHEN cl_abap_typedescr=>typekind_time.
            ...
            IF sy-subrc = 0.
              <fs_time> = <fs_value>.
              lv_value = /nag/cl_excel_common=>time_to_excel_string( ip_value = <fs_time> ).
            ENDIF.
* Begin of change issue #152 - don't touch exisiting style if only value is passed
...
*            lo_style = excel->add_new_style( ).
*            lo_style->number_format->format_code = /nag/cl_excel_style_number_format=>c_format_date_time6.
*            lv_style_guid = lo_style->get_guid( ).
*          ENDIF.
* End of change issue #152 - don't touch exisiting style if only value is passed

          WHEN OTHERS.
            /nag/cx_excel=>raise_text( 'Invalid data type of input value' ).
        ENDCASE.
      ENDIF.
      ...
      IF <fs_sheet_content> IS ASSIGNED AND <fs_sheet_content>-table_header IS NOT INITIAL AND lv_value IS NOT INITIAL.
        ...
        IF sy-subrc = 0.
          ...
          IF <ls_fieldcat>-column_name <> lv_value.
            /nag/cx_excel=>raise_text( 'Cell is table column header - this value is not allowed' ).
          ENDIF.
        ENDIF.
      ENDIF.
...
* End of change issue #152 - don't touch exisiting style if only value is passed
    ...
    ELSE.
      ...
      ls_sheet_content-cell_coords  = /nag/cl_excel_common=>convert_column_a_row2columnrow( i_column = lv_column i_row = lv_row ).
...
*                      If not, use default
    DATA: lo_format_code_datetime TYPE /nag/excel_number_format.
    DATA: stylemapping    TYPE /nag/excel_s_stylemapping.
    ...
    CASE lv_value_type.
      WHEN cl_abap_typedescr=>typekind_date.
        ...
        IF stylemapping-complete_stylex-number_format-format_code IS INITIAL OR
          ...
          lo_format_code_datetime = /nag/cl_excel_style_number_format=>c_format_date_std.
        ELSE.
      ...
      WHEN cl_abap_typedescr=>typekind_time.
        ...
        IF stylemapping-complete_stylex-number_format-format_code IS INITIAL OR
           stylemapping-complete_style-number_format-format_code IS INITIAL.
          lo_format_code_datetime = /nag/cl_excel_style_number_format=>c_format_date_time6.
        ELSE.
          lo_format_code_datetime = stylemapping-complete_style-number_format-format_code.
        ENDIF.
        me->change_cell_style( ip_column                      = lv_column
...
* End of Fix issue #162
  ...
  METHOD set_cell_formula.
    DATA:
      lv_column        TYPE /nag/excel_cell_column,
      lv_row           TYPE /nag/excel_cell_row,
...
*--------------------------------------------------------------------*
  ...
  METHOD set_table_reference.
    ...
    FIELD-SYMBOLS: <ls_sheet_content> TYPE /nag/excel_s_cell_data.
    ...
    ELSE.
      /nag/cx_excel=>raise_text( 'Cell not found' ).
    ENDIF.
  ...
  METHOD set_column_width.
    DATA: lo_column  TYPE REF TO /nag/cl_excel_column.
    DATA: width             TYPE f.
...
* if a fix size is supplied use this
    IF ip_width_fix IS SUPPLIED.
      TRY.
          width = ip_width_fix.
          IF width <= 0.
            /nag/cx_excel=>raise_text( 'Please supply a positive number as column-width' ).
          ENDIF.
          lo_column->set_width( width ).
          RETURN.
        CATCH cx_sy_conversion_no_number.
* Strange stuff passed --> raise error
          /nag/cx_excel=>raise_text( 'Unable to interpret supplied input as number' ).
      ENDTRY.
    ENDIF.
...
* If we get down to here, we have to use whatever is found in autosize.
  ...
  METHOD set_default_excel_date_format.
    ...
    IF ip_default_excel_date_format IS INITIAL.
      /nag/cx_excel=>raise_text( 'Default date format cannot be blank' ).
    ENDIF.
  ...
  METHOD set_merge.
    ...
    DATA: ls_merge        TYPE mty_merge,
          lv_column_start TYPE /nag/excel_cell_column,
          lv_column_end   TYPE /nag/excel_cell_column,
          lv_row          TYPE /nag/excel_cell_row,
          lv_row_to       TYPE /nag/excel_cell_row,
...
*--------------------------------------------------------------------*
  ...
  METHOD set_merge_style.
    DATA: ld_row_start      TYPE /nag/excel_cell_row,
          ld_row_end        TYPE /nag/excel_cell_row,
          ld_column_int     TYPE /nag/excel_cell_column,
          ld_column_start   TYPE /nag/excel_cell_column,
          ld_column_end     TYPE /nag/excel_cell_column,
          ld_current_column TYPE /nag/excel_cell_column_alpha,
          ld_current_row    TYPE /nag/excel_cell_row.
  ...
  METHOD set_pane_top_left_cell.
    DATA lv_column_int TYPE /nag/excel_cell_column.
    DATA lv_row TYPE /nag/excel_cell_row.
    ...
    /nag/cl_excel_common=>convert_columnrow2column_a_row(
      ...
      IMPORTING
        ...
        e_row        = lv_row ).
    IF lv_column_int NOT BETWEEN /nag/cl_excel_common=>c_excel_sheet_min_col AND /nag/cl_excel_common=>c_excel_sheet_max_col
        OR lv_row NOT BETWEEN /nag/cl_excel_common=>c_excel_sheet_min_row AND /nag/cl_excel_common=>c_excel_sheet_max_row.
      RAISE EXCEPTION TYPE /nag/cx_excel EXPORTING error = 'Invalid column/row coordinates (valid values: A1 to XFD1048576)'.
    ENDIF.
  ...
  METHOD set_row_height.
    DATA: lo_row  TYPE REF TO /nag/cl_excel_row.
    DATA: height  TYPE f.
...
* Strange stuff passed --> raise error
  ...
  METHOD set_row_outline.
    ...
    IF sy-subrc <> 0.
      IF iv_row_from <= 0.
        /nag/cx_excel=>raise_text( 'First row of outline must be a positive number' ).
      ENDIF.
      IF iv_row_to < iv_row_from.
        /nag/cx_excel=>raise_text( 'Last row of outline may not be less than first line of outline' ).
      ENDIF.
    ...
    CASE iv_collapsed.
      ...
      WHEN OTHERS.
        /nag/cx_excel=>raise_text( 'Unknown collapse state' ).
  ...
  METHOD set_table.
    ...
    DATA: lo_tabdescr     TYPE REF TO cl_abap_structdescr,
          ...
          lv_column_int   TYPE /nag/excel_cell_column,
          lv_column_alpha TYPE /nag/excel_cell_column_alpha,
          lv_cell_value   TYPE /nag/excel_cell_value.
    ...
    lv_column_int = /nag/cl_excel_common=>convert_column2int( ip_top_left_column ).
...
*--------------------------------------------------------------------*
    DATA: lo_worksheets_iterator TYPE REF TO /nag/cl_excel_collection_iterator,
          ...
          lo_ranges_iterator     TYPE REF TO /nag/cl_excel_collection_iterator,
          lo_range               TYPE REF TO /nag/cl_excel_range,
          lv_range_value         TYPE /nag/excel_range_value,
...
*--------------------------------------------------------------------*
    ...
    WHILE lo_worksheets_iterator->has_next( ) = 'X'.
      ...
      IF ip_title = lo_worksheet->get_title( ).  " Not unique --> raise exception
        ...
        /nag/cx_excel=>raise_text( errormessage ).
      ENDIF.
...
*--------------------------------------------------------------------*
  ...
  METHOD update_dimension_range.
    ...
    DATA: ls_sheet_content TYPE /nag/excel_s_cell_data,
    ...
    IF upper_cell-cell_row = 0.
      upper_cell-cell_row = /nag/cl_excel_common=>c_excel_sheet_max_row.
    ENDIF.
    upper_cell-cell_column = /nag/cl_excel_common=>c_excel_sheet_max_col.

    lower_cell-cell_row = rows->get_max_index( ).
    IF lower_cell-cell_row = 0.
      lower_cell-cell_row = /nag/cl_excel_common=>c_excel_sheet_min_row.
    ENDIF.
    lower_cell-cell_column = /nag/cl_excel_common=>c_excel_sheet_min_col.
    ...
    upper_cell-cell_coords = /nag/cl_excel_common=>convert_column_a_row2columnrow( i_column = upper_cell-cell_column i_row = upper_cell-cell_row ).

    lower_cell-cell_coords = /nag/cl_excel_common=>convert_column_a_row2columnrow( i_column = lower_cell-cell_column i_row = lower_cell-cell_row ).

  ENDMETHOD.                    "UPDATE_DIMENSION_RANGE


  METHOD /nag/if_excel_sheet_printsettings~clear_print_repeat_columns.
...
*--------------------------------------------------------------------*
  ...
  ENDMETHOD.                    "/NAG/IF_EXCEL_SHEET_PRINTSETTINGS~CLEAR_PRINT_REPEAT_COLUMNS


  METHOD /nag/if_excel_sheet_printsettings~clear_print_repeat_rows.
...
*--------------------------------------------------------------------*
  ...
  ENDMETHOD.                    "/NAG/IF_EXCEL_SHEET_PRINTSETTINGS~CLEAR_PRINT_REPEAT_ROWS


  METHOD /nag/if_excel_sheet_printsettings~get_print_repeat_columns.
    ev_columns_from = me->print_title_col_from.
    ev_columns_to   = me->print_title_col_to.
  ENDMETHOD.                    "/NAG/IF_EXCEL_SHEET_PRINTSETTINGS~GET_PRINT_REPEAT_COLUMNS


  METHOD /nag/if_excel_sheet_printsettings~get_print_repeat_rows.
    ev_rows_from = me->print_title_row_from.
    ev_rows_to   = me->print_title_row_to.
  ENDMETHOD.                    "/NAG/IF_EXCEL_SHEET_PRINTSETTINGS~GET_PRINT_REPEAT_ROWS


  METHOD /nag/if_excel_sheet_printsettings~set_print_repeat_columns.
*--------------------------------------------------------------------*
* issue#235 - repeat rows/columns
...
*--------------------------------------------------------------------*
    ...
    lv_col_from_int = /nag/cl_excel_common=>convert_column2int( iv_columns_from ).
    lv_col_to_int   = /nag/cl_excel_common=>convert_column2int( iv_columns_to ).
...
*--------------------------------------------------------------------*
  ...
  ENDMETHOD.                    "/NAG/IF_EXCEL_SHEET_PRINTSETTINGS~SET_PRINT_REPEAT_COLUMNS


  METHOD /nag/if_excel_sheet_printsettings~set_print_repeat_rows.
*--------------------------------------------------------------------*
* issue#235 - repeat rows/columns
*           - Stefan Schmöcker,                             2012-12-02
*--------------------------------------------------------------------*
...
*--------------------------------------------------------------------*
  ...
  ENDMETHOD.                    "/NAG/IF_EXCEL_SHEET_PRINTSETTINGS~SET_PRINT_REPEAT_ROWS


  METHOD /nag/if_excel_sheet_properties~get_right_to_left.
    result = right_to_left.
  ENDMETHOD.


  METHOD /nag/if_excel_sheet_properties~get_style.
    IF /nag/if_excel_sheet_properties~style IS NOT INITIAL.
      ep_style = /nag/if_excel_sheet_properties~style.
    ELSE.
      ep_style = me->excel->get_default_style( ).
    ENDIF.
  ENDMETHOD.                    "/NAG/IF_EXCEL_SHEET_PROPERTIES~GET_STYLE


  METHOD /nag/if_excel_sheet_properties~initialize.

    /nag/if_excel_sheet_properties~show_zeros   = /nag/if_excel_sheet_properties=>c_showzero.
    /nag/if_excel_sheet_properties~summarybelow = /nag/if_excel_sheet_properties=>c_below_on.
    /nag/if_excel_sheet_properties~summaryright = /nag/if_excel_sheet_properties=>c_right_on.

* inizialize zoomscale values
    /nag/if_excel_sheet_properties~zoomscale = 100.
    /nag/if_excel_sheet_properties~zoomscale_normal = 100.
    /nag/if_excel_sheet_properties~zoomscale_pagelayoutview = 100 .
    /nag/if_excel_sheet_properties~zoomscale_sheetlayoutview = 100 .
  ENDMETHOD.                    "/NAG/IF_EXCEL_SHEET_PROPERTIES~INITIALIZE


  METHOD /nag/if_excel_sheet_properties~set_right_to_left.
    me->right_to_left = right_to_left.
  ENDMETHOD.


  METHOD /nag/if_excel_sheet_properties~set_style.
    /nag/if_excel_sheet_properties~style = ip_style.
  ENDMETHOD.                    "/NAG/IF_EXCEL_SHEET_PROPERTIES~SET_STYLE


  METHOD /nag/if_excel_sheet_protection~initialize.

    me->/nag/if_excel_sheet_protection~protected = /nag/if_excel_sheet_protection=>c_unprotected.
    CLEAR me->/nag/if_excel_sheet_protection~password.
    me->/nag/if_excel_sheet_protection~auto_filter            = /nag/if_excel_sheet_protection=>c_noactive.
    me->/nag/if_excel_sheet_protection~delete_columns         = /nag/if_excel_sheet_protection=>c_noactive.
    me->/nag/if_excel_sheet_protection~delete_rows            = /nag/if_excel_sheet_protection=>c_noactive.
    me->/nag/if_excel_sheet_protection~format_cells           = /nag/if_excel_sheet_protection=>c_noactive.
    me->/nag/if_excel_sheet_protection~format_columns         = /nag/if_excel_sheet_protection=>c_noactive.
    me->/nag/if_excel_sheet_protection~format_rows            = /nag/if_excel_sheet_protection=>c_noactive.
    me->/nag/if_excel_sheet_protection~insert_columns         = /nag/if_excel_sheet_protection=>c_noactive.
    me->/nag/if_excel_sheet_protection~insert_hyperlinks      = /nag/if_excel_sheet_protection=>c_noactive.
    me->/nag/if_excel_sheet_protection~insert_rows            = /nag/if_excel_sheet_protection=>c_noactive.
    me->/nag/if_excel_sheet_protection~objects                = /nag/if_excel_sheet_protection=>c_noactive.
*  me->/nag/if_excel_sheet_protection~password               = /nag/if_excel_sheet_protection=>c_noactive. "issue #68
    me->/nag/if_excel_sheet_protection~pivot_tables           = /nag/if_excel_sheet_protection=>c_noactive.
    me->/nag/if_excel_sheet_protection~protected              = /nag/if_excel_sheet_protection=>c_noactive.
    me->/nag/if_excel_sheet_protection~scenarios              = /nag/if_excel_sheet_protection=>c_noactive.
    me->/nag/if_excel_sheet_protection~select_locked_cells    = /nag/if_excel_sheet_protection=>c_noactive.
    me->/nag/if_excel_sheet_protection~select_unlocked_cells  = /nag/if_excel_sheet_protection=>c_noactive.
    me->/nag/if_excel_sheet_protection~sheet                  = /nag/if_excel_sheet_protection=>c_noactive.
    me->/nag/if_excel_sheet_protection~sort                   = /nag/if_excel_sheet_protection=>c_noactive.

  ENDMETHOD.                    "/NAG/IF_EXCEL_SHEET_PROTECTION~INITIALIZE


  METHOD /nag/if_excel_sheet_vba_project~set_codename.
    me->/nag/if_excel_sheet_vba_project~codename = ip_codename.
  ENDMETHOD.                    "/NAG/IF_EXCEL_SHEET_VBA_PROJECT~SET_CODENAME


  METHOD /nag/if_excel_sheet_vba_project~set_codename_pr.
    me->/nag/if_excel_sheet_vba_project~codename_pr = ip_codename_pr.
  ENDMETHOD.                    "/NAG/IF_EXCEL_SHEET_VBA_PROJECT~SET_CODENAME_PR
ENDCLASS.

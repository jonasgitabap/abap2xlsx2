CLASS /nag/cl_excel_converter_result_ex DEFINITION
  PUBLIC
  INHERITING FROM /nag/cl_excel_converter_result
  FINAL
  CREATE PUBLIC .

*"* public components of class /NAG/CL_EXCEL_CONVERTER_RESULT_EX
*"* do not include other source files here!!!
  PUBLIC SECTION.
    ...
    METHODS /nag/if_excel_converter~get_supported_class
        REDEFINITION .
*"* protected components of class /NAG/CL_EXCEL_CONVERTER_RESULT_EX
*"* do not include other source files here!!!
*"* protected components of class /NAG/CL_EXCEL_CONVERTER_RESULT_EX
*"* do not include other source files here!!!
*"* protected components of class /NAG/CL_EXCEL_CONVERTER_RESULT_EX
*"* do not include other source files here!!!
  PROTECTED SECTION.
*"* private components of class /NAG/CL_EXCEL_CONVERTER_EX_RESULT
*"* do not include other source files here!!!
  PRIVATE SECTION.
ENDCLASS.
...
CLASS /nag/cl_excel_converter_result_ex IMPLEMENTATION.

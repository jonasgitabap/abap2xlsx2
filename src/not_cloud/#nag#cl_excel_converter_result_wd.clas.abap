CLASS /nag/cl_excel_converter_result_wd DEFINITION
  PUBLIC
  INHERITING FROM /nag/cl_excel_converter_result
  FINAL
  CREATE PUBLIC .

*"* public components of class /NAG/CL_EXCEL_CONVERTER_RESULT_WD
*"* do not include other source files here!!!
  PUBLIC SECTION.
    ...
    METHODS /nag/if_excel_converter~get_supported_class
        REDEFINITION .
*"* protected components of class /NAG/CL_EXCEL_CONVERTER_RESULT_WD
*"* do not include other source files here!!!
*"* protected components of class /NAG/CL_EXCEL_CONVERTER_RESULT_WD
*"* do not include other source files here!!!
*"* protected components of class /NAG/CL_EXCEL_CONVERTER_RESULT_WD
...
CLASS /nag/cl_excel_converter_result_wd IMPLEMENTATION.

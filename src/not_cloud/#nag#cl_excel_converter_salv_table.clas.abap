CLASS /nag/cl_excel_converter_salv_table DEFINITION
  PUBLIC
  INHERITING FROM /nag/cl_excel_converter_alv
  FINAL
  CREATE PUBLIC .

*"* public components of class /NAG/CL_EXCEL_CONVERTER_SALV_TABLE
*"* do not include other source files here!!!
  PUBLIC SECTION.
    ...
    METHODS /nag/if_excel_converter~get_supported_class
        REDEFINITION .
*"* protected components of class /NAG/CL_EXCEL_CONVERTER_SALV_TABLE
*"* do not include other source files here!!!
*"* protected components of class /NAG/CL_EXCEL_CONVERTER_SALV_TABLE
*"* do not include other source files here!!!
*"* protected components of class /NAG/CL_EXCEL_CONVERTER_SALV_TABLE
...
CLASS /nag/cl_excel_converter_salv_table IMPLEMENTATION.
...
* First update metadata if we can.
    IF io_salv->is_offline( ) = abap_false.
      ...
      ELSE.
        IF /nag/cl_excel_converter_salv_model=>is_get_metadata_callable( io_salv ) = abap_true.

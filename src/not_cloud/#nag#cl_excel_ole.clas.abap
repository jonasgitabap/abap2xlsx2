CLASS /nag/cl_excel_ole DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS /nag/cl_excel_ole IMPLEMENTATION.
...
* get dependent field field: currency and quantity
    ...
    DO l_num TIMES.
      ...
      TO <f_excel_column>.
      IF sy-subrc NE 0.
        MESSAGE e801(/nag/abap2xlsx) WITH 'FATAL ERROR' RAISING fatal_error.
      ENDIF.

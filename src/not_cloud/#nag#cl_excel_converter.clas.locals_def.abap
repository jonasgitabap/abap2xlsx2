...
TYPES:   BEGIN OF ts_sort_values,
            ...
            row_int        TYPE /nag/excel_cell_row,
...
TYPES:   BEGIN OF ts_subtotal_rows,
            row_int        TYPE /nag/excel_cell_row,
            row_int_start  TYPE /nag/excel_cell_row,
...
TYPES:   BEGIN OF ts_styles,
            ...
            alignment    TYPE /nag/excel_alignment,
...
TYPES:   BEGIN OF ts_color_styles,
            guid_old  TYPE /nag/excel_cell_style,
            fontcolor TYPE /nag/excel_style_color_argb,
            fillcolor TYPE /nag/excel_style_color_argb,
            style_new TYPE REF TO /nag/cl_excel_style,

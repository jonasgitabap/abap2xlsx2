CLASS /nag/cl_excel_style DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .

*"* public components of class /NAG/CL_EXCEL_STYLE
*"* do not include other source files here!!!
  PUBLIC SECTION.

    DATA font TYPE REF TO /nag/cl_excel_style_font .
    DATA fill TYPE REF TO /nag/cl_excel_style_fill .
    DATA borders TYPE REF TO /nag/cl_excel_style_borders .
    DATA alignment TYPE REF TO /nag/cl_excel_style_alignment .
    DATA number_format TYPE REF TO /nag/cl_excel_style_number_format .
    DATA protection TYPE REF TO /nag/cl_excel_style_protection .
...
*"* protected components of class /NAG/ABAP_EXCEL_STYLE
*"* do not include other source files here!!!
  PROTECTED SECTION.
*"* private components of class /NAG/CL_EXCEL_STYLE
*"* do not include other source files here!!!
  PRIVATE SECTION.
...
CLASS /nag/cl_excel_style IMPLEMENTATION.

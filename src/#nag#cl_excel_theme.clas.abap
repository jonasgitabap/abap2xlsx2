CLASS /nag/cl_excel_theme DEFINITION
  PUBLIC
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    METHODS set_color
      IMPORTING
        ...
        VALUE(iv_srgb)         TYPE /nag/cl_excel_theme_color_scheme=>t_srgb OPTIONAL
        VALUE(iv_syscolorname) TYPE string OPTIONAL
        VALUE(iv_syscolorlast) TYPE /nag/cl_excel_theme_color_scheme=>t_srgb OPTIONAL .
  ...
  PROTECTED SECTION.
    ...
    DATA elements TYPE REF TO /nag/cl_excel_theme_elements .
    DATA objectdefaults TYPE REF TO /nag/cl_excel_theme_objectdefaults .
    DATA extclrschemelst TYPE REF TO /nag/cl_excel_theme_eclrschemelst .
    DATA extlst TYPE REF TO /nag/cl_excel_theme_extlst .
  PRIVATE SECTION.
...
CLASS /nag/cl_excel_theme IMPLEMENTATION.

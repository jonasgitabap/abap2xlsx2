CLASS /nag/cl_excel_reader_xlsm DEFINITION
  PUBLIC
  INHERITING FROM /nag/cl_excel_reader_2007
  FINAL
  CREATE PUBLIC .

  PUBLIC SECTION.
*"* public components of class /NAG/CL_EXCEL_READER_XLSM
*"* do not include other source files here!!!
  PROTECTED SECTION.

*"* protected components of class /NAG/CL_EXCEL_READER_XLSM
*"* do not include other source files here!!!
...
*"* private components of class /NAG/CL_EXCEL_READER_XLSM
*"* do not include other source files here!!!
...
CLASS /nag/cl_excel_reader_xlsm IMPLEMENTATION.
  ...
  METHOD load_vbaproject.
    ...
    ip_excel->/nag/if_excel_book_vba_project~set_vbaproject( lv_content ).
  ...
  METHOD load_workbook.
    ...
    IF node IS BOUND.
      ...
      io_excel->/nag/if_excel_book_vba_project~set_codename( fileversion-codename ).
    ENDIF.
    ...
    IF node IS BOUND.
      ...
      io_excel->/nag/if_excel_book_vba_project~set_codename_pr( workbookpr-codename ).
    ENDIF.
  ...
  METHOD load_worksheet.
    ...
    IF node IS BOUND.
      ...
      IF sheetpr-codename IS NOT INITIAL.
        io_worksheet->/nag/if_excel_sheet_vba_project~set_codename_pr( sheetpr-codename ).
      ENDIF.
    ENDIF.
  ENDMETHOD.
ENDCLASS.

CLASS /nag/cl_excel_drawing DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .

  PUBLIC SECTION.
    CONSTANTS c_graph_pie TYPE /nag/excel_graph_type VALUE 1.   "#EC NOTEXT
    CONSTANTS c_graph_line TYPE /nag/excel_graph_type VALUE 2.  "#EC NOTEXT
    CONSTANTS c_graph_bars TYPE /nag/excel_graph_type VALUE 0.  "#EC NOTEXT
    DATA graph_type TYPE /nag/excel_graph_type .
    DATA title TYPE string VALUE 'image1.jpg'.              "#EC NOTEXT
    CONSTANTS type_image TYPE /nag/excel_drawing_type VALUE 'image'. "#EC NOTEXT
    CONSTANTS type_chart TYPE /nag/excel_drawing_type VALUE 'chart'. "#EC NOTEXT
    CONSTANTS anchor_absolute TYPE /nag/excel_drawing_anchor VALUE 'ABS'. "#EC NOTEXT
    CONSTANTS anchor_one_cell TYPE /nag/excel_drawing_anchor VALUE 'ONE'. "#EC NOTEXT
    CONSTANTS anchor_two_cell TYPE /nag/excel_drawing_anchor VALUE 'TWO'. "#EC NOTEXT
    DATA graph TYPE REF TO /nag/cl_excel_graph .
    ...
    CONSTANTS type_image_header_footer TYPE /nag/excel_drawing_type VALUE 'hd_ft'. "#EC NOTEXT
    ...
    METHODS get_from_col
      RETURNING
        VALUE(r_from_col) TYPE /nag/excel_cell_column .
    METHODS get_from_row
      RETURNING
        VALUE(r_from_row) TYPE /nag/excel_cell_row .
    METHODS get_guid
      RETURNING
        VALUE(ep_guid) TYPE /nag/excel_guid .
    ...
    METHODS get_to_col
      RETURNING
        VALUE(r_to_col) TYPE /nag/excel_cell_column .
    METHODS get_to_row
      RETURNING
        VALUE(r_to_row) TYPE /nag/excel_cell_row .
    ...
    METHODS set_position
      IMPORTING
        !ip_from_row TYPE /nag/excel_cell_row
        !ip_from_col TYPE /nag/excel_cell_column_alpha
    ...
    METHODS set_position2
      IMPORTING
        !ip_from   TYPE /nag/excel_drawing_location
        !ip_to     TYPE /nag/excel_drawing_location
        !ip_anchor TYPE /nag/excel_drawing_anchor OPTIONAL .
    METHODS get_position
      RETURNING
        VALUE(rp_position) TYPE /nag/excel_drawing_position .
    METHODS get_type
      RETURNING
        VALUE(rp_type) TYPE /nag/excel_drawing_type .
    METHODS get_index
      RETURNING
...
*"* private components of class /NAG/CL_EXCEL_DRAWING
*"* do not include other source files here!!!
    DATA type TYPE /nag/excel_drawing_type VALUE type_image. "#EC NOTEXT .  .  .  .  .  .  .  .  .  .  . " .
    DATA index TYPE string .
    DATA anchor TYPE /nag/excel_drawing_anchor VALUE anchor_one_cell. "#EC NOTEXT .  .  .  .  .  .  .  .  .  .  . " .
    ...
    DATA from_loc TYPE /nag/excel_drawing_location .
    DATA to_loc TYPE /nag/excel_drawing_location .
    DATA size TYPE /nag/excel_drawing_size .
...
CLASS /NAG/CL_EXCEL_DRAWING IMPLEMENTATION.
...
* suppose 96 DPI
  ...
  METHOD load_chart_attributes.
    ...
    DATA lo_barchart TYPE REF TO /nag/cl_excel_graph_bars.
    DATA lo_piechart TYPE REF TO /nag/cl_excel_graph_pie.
    DATA lo_linechart TYPE REF TO /nag/cl_excel_graph_line.
    ...
    /nag/cl_excel_reader_2007=>fill_struct_from_attributes( EXPORTING ip_element = node2 CHANGING cp_structure = ls_prop ).
...
*           depth     = 0
        ...
        WHILE lo_node IS BOUND.
          ...
          /nag/cl_excel_reader_2007=>fill_struct_from_attributes( EXPORTING ip_element = node3 CHANGING cp_structure = ls_prop ).
          lv_idx = ls_prop-val.
        ...
        WHILE lo_node IS BOUND.
          ...
          IF sy-index EQ 1. "catAx
            ...
            CALL METHOD lo_barchart->create_ax
              EXPORTING
                ip_axid          = lv_axid
                ip_type          = /nag/cl_excel_graph_bars=>c_catax
          ...
          ELSEIF sy-index EQ 2. "valAx
            ...
            CALL METHOD lo_barchart->create_ax
              EXPORTING
                ip_axid          = lv_axid
                ip_type          = /nag/cl_excel_graph_bars=>c_valax
                ip_orientation   = lv_orientation
                ip_delete        = lv_delete
                ip_axpos         = lv_axpos
                ip_formatcode    = lv_formatcode
...
*           depth     = 0
        ...
        WHILE lo_node IS BOUND.
          ...
          IF sy-index EQ 1. "catAx
            ...
            CALL METHOD lo_linechart->create_ax
              EXPORTING
                ip_axid          = lv_axid
                ip_type          = /nag/cl_excel_graph_line=>c_catax
                ip_orientation   = lv_orientation
                ip_delete        = lv_delete
                ip_axpos         = lv_axpos
                ip_formatcode    = lv_formatcode
          ...
          ELSEIF sy-index EQ 2. "valAx
            ...
            CALL METHOD lo_linechart->create_ax
              EXPORTING
                ip_axid          = lv_axid
                ip_type          = /nag/cl_excel_graph_line=>c_valax
                ip_orientation   = lv_orientation
                ip_delete        = lv_delete
                ip_axpos         = lv_axpos
                ip_formatcode    = lv_formatcode
    ...
    /nag/cl_excel_reader_2007=>fill_struct_from_attributes( EXPORTING ip_element = node2 CHANGING cp_structure = ls_pagemargins ).
...
* suppose 96 DPI
  ...
  METHOD set_position.
    from_loc-col = /nag/cl_excel_common=>convert_column2int( ip_from_col ) - 1.
  ...
  METHOD set_position2.
    ...
    DATA: lv_anchor                     TYPE /nag/excel_drawing_anchor.
    lv_anchor = ip_anchor.

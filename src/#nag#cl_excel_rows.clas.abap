*----------------------------------------------------------------------*
*       CLASS /NAG/CL_EXCEL_ROWS DEFINITION
*----------------------------------------------------------------------*
*
*----------------------------------------------------------------------*
CLASS /nag/cl_excel_rows DEFINITION
...
*"* public components of class /NAG/CL_EXCEL_ROWS
...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    METHODS add
      IMPORTING
        !io_row TYPE REF TO /nag/cl_excel_row .
    METHODS clear .
    METHODS constructor .
    METHODS get
      IMPORTING
...
CLASS /nag/cl_excel_rows IMPLEMENTATION.
